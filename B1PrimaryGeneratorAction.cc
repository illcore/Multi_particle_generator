...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
//28-bin Cosmic Proton/Alpha Spectrum - by AIT
void B1PrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{
for (int n_particle = 1; n_particle < 10000; n_particle++){
//Discrete probabilities for protons
...
0.000146558, 0.000098744, 0.000063750, 0.000032568, 0.000014343, 0.000007483}; 
//Discrete energies for alpha
...
27100, 31400, 36700, 42900, 49900, 62500, 86100, 116000};
double Grid1[29];
double Grid2[29];
double sum=0;
...
if(particleName=="proton"){  
  ...
  GridFile1.open("Probability_grid1.txt", std::ios::app);
  ...
  EnergyFile1.open("Energy1.txt", std::ios::app);
...
if(particleName=="alpha"){  
  ...
  GridFile2.open("Probability_grid2.txt", std::ios::app);
  GridFile2 <<  Grid1[x] << G4endl;
  GridFile2.close();
  }  
  G4double y0 = 85*cm;
  G4double z0 = 0.5*cm;
  ...
  EnergyFile2.open("Energy2.txt", std::ios::app);
